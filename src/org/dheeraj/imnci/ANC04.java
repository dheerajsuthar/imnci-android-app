...
public class ANC04 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String tableName = "anc_04";
		String labels[] = { "ID", "anc date", "anaemia", "complication",
				"rti sti" };
		...
		for (Data data : dataMap) {
			...
			if (data.getLabel().equals("anc date")) {
				showDateDialog(data);
	...
	void showDateDialog(Data data) {
		...
		dateButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				dobDialog = new DatePickerDialog(ANC04.this, l, c
