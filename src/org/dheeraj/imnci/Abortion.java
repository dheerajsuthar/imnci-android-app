...
public class Abortion extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String tableName = "abortions";
		String labels[] = { "ID", "place of abortion", "date of abortion" };
		String places_of_abortions[] = { "SBA", "NSBA", "HSC", "PHC", "CHC",
				"SDH", "DH", "P" };
		...
		for (Data data : dataMap) {
			...
			if (data.getLabel().equals("place of abortion")) {
				showSpinner(data, places_of_abortions);
			} else if (data.getLabel().equals("date of abortion")) {
				showDateDialog(data);
	...
	void showDateDialog(Data data) {
		...
		dateButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				dobDialog = new DatePickerDialog(Abortion.this, l, c
