...
public class IFA extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String tableName = "ifa";
		String labels[] = { "ID", "ifa date", "anaemia", "complication",
				"rti sti" };
		...
		for (Data data : dataMap) {
			...
			if (data.getLabel().equals("ifa date")) {
				showDateDialog(data);
	...
	void showDateDialog(Data data) {
		...
		dateButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				dobDialog = new DatePickerDialog(IFA.this, l, c
