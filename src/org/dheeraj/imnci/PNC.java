...
public class PNC extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String tableName = "pnc";
		String labels[] = { "ID", "home visit", "complication", "PPCM",
				"checkup" };
		String home_visits[] = { "00", "48h", "7d" };
		String complications[] = { "S", "D", "O", "N" };
		String ppcms[] = { "S", "IUD", "I", "O" };
		String checkups[] = { "Y", "N" };
		...
		for (Data data : dataMap) {
			...
			if (data.getLabel().equals("home visit")) {
				showSpinner(data, home_visits);
			} else if (data.getLabel().equals("complication")) {
				showSpinner(data, complications);

			} else if (data.getLabel().equals("PPCM")) {
				showSpinner(data, ppcms);

			} else if (data.getLabel().equals("checkup")) {
				showSpinner(data, checkups);
	...
	void showDateDialog(Data data) {
		...
		dateButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				dobDialog = new DatePickerDialog(PNC.this, l, c
